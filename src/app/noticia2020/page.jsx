...
import styles from '../noticia2020/Noticia2020.module.css';
...
export default function Noticias() {
  ...
  useEffect(() => {
    fetch('http://localhost:4000/api/news?decade=2020s', {
      headers: {
  ...
  return (
    <div>
      <Banner title="DÉCADA DE 20" image="/images/imagem22.png" />
      <VoltarDecadasButton />
